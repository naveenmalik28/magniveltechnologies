...
export function PageHeader({
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/5 bg-grid gradient-mesh py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="font-heading mt-6 max-w-4xl text-4xl font-extrabold uppercase leading-[1.1] tracking-widest text-white sm:text-5xl lg:text-6xl">
          {title}
        </h1>
...
export function SectionTitle({
  ...
  return (
    <div className={`max-w-3xl ${centered ? "mx-auto text-center" : ""} ${className}`}>
      ...
      <h2 className="font-heading mt-4 text-3xl font-extrabold uppercase leading-[1.1] tracking-widest text-white sm:text-4xl lg:text-5xl">
        {title}
      </h2>
      {description ? (
