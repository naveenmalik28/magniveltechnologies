    ...
    >
      ...
      <div className="glass-card relative p-4 sm:p-5 md:p-6">
        ...
        <div className="flex items-center justify-between border-b border-white/8 pb-3 sm:pb-4">
          ...
          <span className="font-mono text-[9px] font-bold uppercase tracking-widest text-accent-light sm:text-[10px]">
        ...
        <div className="mt-3 grid gap-3 sm:mt-4 sm:gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative aspect-[4/3] rounded-xl border border-white/6 bg-[#0b1020]/80 p-3 sm:p-4 lg:aspect-auto lg:min-h-[240px]">
            ...
            {/* Floating icons */}
            <motion.div
              className="absolute right-2 top-2 flex h-6 w-6 items-center justify-center rounded-lg border border-accent/30 bg-accent/10 text-accent-dark sm:right-3 sm:top-3 sm:h-8 sm:w-8"
              animate={{ y: [0, -4, 0] }}
            ...
            <motion.div
              className="absolute bottom-2 left-2 flex h-6 w-6 items-center justify-center rounded-lg border border-accent-light/30 bg-accent-light/10 text-accent-light sm:bottom-3 sm:left-3 sm:h-8 sm:w-8"
              animate={{ y: [0, 4, 0] }}
              ...
              <div className="rounded-xl border border-white/6 bg-[#0b1020]/60 p-2 sm:p-2.5">
                <div className="mx-auto w-10 rounded-lg border border-white/10 bg-surface p-1 sm:w-12 sm:p-1.5">
                  ...
                  <div className="space-y-0.5 sm:space-y-1">
                    <div className="h-0.5 w-full rounded bg-accent/40 sm:h-1" />
                    <div className="h-0.5 w-3/4 rounded bg-accent-light/30 sm:h-1" />
                    <div className="h-0.5 w-1/2 rounded bg-accent-secondary/30 sm:h-1" />
                  </div>
                </div>
